    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ url('Hasil-Data') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="col-6 text-end">
                      <a class="btn bg-gradient-dark mb-0" href="{{ route('print.pdf') }}"><i class="fas fa-print"></i>&nbsp;&nbsp;Print</a>
                    </div>
                  </div>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <div class="print-table-container">
                                    <table class="table align-items-center mb-0" id="data-table-hasil-klasifikasi">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($testing as $data)
                                                <tr>
                                                    ...
                                                    <td >
                                                        <span
                                                            class="text-xs font-weight-bold">{{ $data->Klasifikasi}}</span>
                                                    </td>                                                    
                                                </tr>
                                                @php
                                                    $counter++;
